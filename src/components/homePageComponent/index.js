...
const HomePageComponent = () => {
    ...
    const deleteTask = async (id) => {
        ...
        const confirmTaskDelete = await Swal.fire({
            title: "Delete this task?",
            text: "Are you sure? You won’t be able to undo this later.",
            icon: "warning",
        ...
        if (!confirmTaskDelete.isConfirmed) return;

        try {
            await axios.delete(
                `${process.env.NEXT_PUBLIC_API_URL}/task/delete/${id}`,
                {
